...
public class FldMoveModifyAssetNewGLAccount extends psdi.app.asset.FldMoveModifyAssetNewGLAccount
{
	private String CLASS_NAME = this.getClass().getName();
	
	public FldMoveModifyAssetNewGLAccount(MboValue mbv)
	  {
	    super(mbv);
	  }
