...
public class FldPOLineGLDebitAcct extends psdi.app.common.purchasing.FldPurGLDebitAcct implements ValGLConstants{

	private String CLASS_NAME = this.getClass().getName();

	public FldPOLineGLDebitAcct(MboValue mbv) throws RemoteException, MXException {
		super(mbv);
	}
