...
public class FldPRLineGLCreditAcct extends psdi.app.common.purchasing.FldPurGLCreditAcct implements ValGLConstants{

	private String CLASS_NAME = this.getClass().getName();

	public FldPRLineGLCreditAcct(MboValue mbv) throws RemoteException, MXException {
		super(mbv);
	}
