...
public class X1FldFullGLAccount extends psdi.app.financial.FldFullGLAccount implements ValGLConstants 
{
	private String CLASS_NAME = this.getClass().getName();

	public X1FldFullGLAccount(MboValue mbv) throws RemoteException {
		super(mbv);
	}
