...
public class FldInvoiceCostGLCreditAcctNonPer extends psdi.app.invoice.FldInvoiceCostGLCreditAcctNonPer implements ValGLConstants{

	private String CLASS_NAME = this.getClass().getName();

	public FldInvoiceCostGLCreditAcctNonPer(MboValue mbv) throws RemoteException {
		super(mbv);
	}
