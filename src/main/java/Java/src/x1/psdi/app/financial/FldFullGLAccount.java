...
public class FldFullGLAccount extends psdi.app.financial.FldFullGLAccount implements ValGLConstants {

	private String CLASS_NAME = this.getClass().getName();

	public FldFullGLAccount(MboValue mbv) throws RemoteException {
		super(mbv);
	}
