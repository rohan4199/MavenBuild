package x1.psdi.app.common.purchasing;
...
public class FldPOLineGLCreditAcct extends psdi.app.common.purchasing.FldPurGLCreditAcct implements ValGLConstants{

	private String CLASS_NAME = this.getClass().getName();

	public FldPOLineGLCreditAcct(MboValue mbv) throws RemoteException, MXException {
		super(mbv);
	}
