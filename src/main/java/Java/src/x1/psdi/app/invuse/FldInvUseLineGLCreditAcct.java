...
public class FldInvUseLineGLCreditAcct extends psdi.app.financial.FldFullGLAccount implements ValGLConstants{

	private String CLASS_NAME = this.getClass().getName();

	public FldInvUseLineGLCreditAcct(MboValue mbv) throws RemoteException, MXException {
		super(mbv);
	}
