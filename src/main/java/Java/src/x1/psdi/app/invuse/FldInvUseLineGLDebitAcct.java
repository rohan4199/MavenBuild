...
public class FldInvUseLineGLDebitAcct extends psdi.app.financial.FldPartialGLAccount implements ValGLConstants{

	private String CLASS_NAME = this.getClass().getName();

	public FldInvUseLineGLDebitAcct(MboValue mbv) throws RemoteException, MXException {
		super(mbv);
	}
