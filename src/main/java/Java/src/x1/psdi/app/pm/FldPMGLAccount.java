...
public class FldPMGLAccount extends psdi.app.financial.FldPartialGLAccount implements ValGLConstants {

	private String CLASS_NAME = this.getClass().getName();

	public FldPMGLAccount(MboValue mbv)  throws RemoteException, MXException {
		super(mbv);		
	}
