...
public class FldInvoiceCostGLDebitAcctNonPer extends psdi.app.invoice.FldInvoiceCostGLDebitAcctNonPer implements ValGLConstants{

	private String CLASS_NAME = this.getClass().getName();

	public FldInvoiceCostGLDebitAcctNonPer(MboValue mbv) throws RemoteException {
		super(mbv);
	}
