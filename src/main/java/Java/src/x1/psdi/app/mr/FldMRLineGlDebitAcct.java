...
public class FldMRLineGlDebitAcct extends psdi.app.mr.FldMRLineGlDebitAcct {

	private String CLASS_NAME = this.getClass().getName();

	public FldMRLineGlDebitAcct(MboValue mbv) throws MXException {
		super(mbv);
