...
public class FldPRLineGLDebitAcct extends psdi.app.common.purchasing.FldPurGLDebitAcct implements ValGLConstants{

	private String CLASS_NAME = this.getClass().getName();

	public FldPRLineGLDebitAcct(MboValue mbv) throws RemoteException, MXException {
		super(mbv);
	}
