...
public class FldInvoiceCostGLDebitAcct extends psdi.app.invoice.FldInvoiceCostGLDebitAcct implements ValGLConstants{

	private String CLASS_NAME = this.getClass().getName();

	public FldInvoiceCostGLDebitAcct(MboValue mbv) throws RemoteException {
		super(mbv);
	}
