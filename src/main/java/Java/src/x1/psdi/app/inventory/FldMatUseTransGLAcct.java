...
public class FldMatUseTransGLAcct extends psdi.app.inventory.FldMatUseTransGLAcct {

	private String CLASS_NAME = this.getClass().getName();
	public FldMatUseTransGLAcct(MboValue mbv) throws MXException, RemoteException {
		super(mbv);
